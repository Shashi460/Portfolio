  ...
  return (
    <div>
      ...
      <div className="max-w-4xl">
        ...
        <Paragraph className=" mt-4">
          What sets me apart is my dedication to creating with purpose. Whether it&apos;s a Prompt sharing app, a Modern banking application, or a portfolio tracker, I ensure every project merges technical excellence with thoughtful design.
        </Paragraph>
        <Paragraph className=" mt-4">
